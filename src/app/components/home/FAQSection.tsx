...
export function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Да, конечно! Первое занятие по любому направлению полностью бесплатно при покупке абонемента. Приходите, познакомьтесь с педагогом и посмотрите, как всё устроено. В случае, если вы решите не посещать наши занятия, пробное занятие оплачивается 50% от его стоимости.",
    },
    {
