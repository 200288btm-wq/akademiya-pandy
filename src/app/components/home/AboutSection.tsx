        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            <h2 className="font-['Nunito',sans-serif] font-bold text-4xl md:text-5xl text-[#0c0805]">
              {"Академия Панды — больше чем занятия"}
            </h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-['Nunito_Sans',sans-serif] text-base text-[#4a4a4a]">
                    {"Занятия построены с учётом того, как работает мозг ребёнка. Только интерес и радость от процесса."}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-['Nunito_Sans',sans-serif] text-base text-[#4a4a4a]">
                    {"г. Екатеринбург, ул. Хуторская 1 — Ботанический район, совсем близко."}
                  </p>
                </div>
              </div>
            </div>
